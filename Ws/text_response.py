...
async def prompt_text_generation(script):
    global messages
    SYSTEM_PROMPT = f"""
        You are an interview taking agent , whose role is to take interview of a candidate based on the script provided.You can also provide emotions like given in the script so it will be helpfull for the audio
        generator to impersonate a real interviewer and give user a real interview experience
